...
final class SingleDocumentBenchmarks: Benchmark {
    static var allTests: [(String, (SingleDocumentBenchmarks) -> () throws -> Void)] {
        return [
            ("testRunCommand", testRunCommand),
            ("testFindOneById", testFindOneById),
            ("testSmallDocInsertOne", testSmallDocInsertOne),
            ("testLargeDocInsertOne", testLargeDocInsertOne)
        ]
    }
...
final class MultiDocumentBenchmarks: Benchmark {
    static var allTests: [(String, (MultiDocumentBenchmarks) -> () throws -> Void)] {
        return [
